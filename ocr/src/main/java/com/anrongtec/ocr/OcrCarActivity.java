 ...
 * OCR 车牌号扫描页面
 */
public class OcrCarActivity extends Activity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    private void findView() {
        ...
        surfaceHolder.addCallback(OcrCarActivity.this);
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        if (!alertDialog.isShowing()) {
            ...
            if (r == 0) {
                ...
                //通知相册更新图片
                OcrCarActivity.this.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(strFilePath))));
                OcrCarActivity.this.sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(strFileRROIPath))));
            }
        }
    }
