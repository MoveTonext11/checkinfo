...
import com.carkeyboard.R;
import com.carkeyboard.core.EngineRunner;
import com.carkeyboard.core.KeyEntry;
import com.carkeyboard.core.KeyType;
import com.carkeyboard.core.KeyboardEntry;
import com.carkeyboard.core.KeyboardType;
import com.carkeyboard.core.NumberType;
import com.carkeyboard.support.Texts;
...
public class KeyboardView extends LinearLayout {
    ...
    public KeyboardView(Context context, @Nullable AttributeSet attrs) {
        ...
        /**
         * Aton 设置全局键盘模式
         *  具体类可以指定具体键盘：mPopupKeyboard.getKeyboardView().setKeyboardType(KeyboardType.CIVIL);
         */

        int type = ta.getInt(R.styleable.KeyboardView_pwkKeyboardType, 1);
        ta.recycle();
        ...
        final Drawable rowDivider = ContextCompat.getDrawable(context, R.drawable
                .pwk_space_vertical);
        ...
        final int leftPadding = getResources().getDimensionPixelSize(R.dimen
                .pwk_keyboard_padding_left);
        final int topPadding = getResources().getDimensionPixelSize(R.dimen
                .pwk_keyboard_padding_top);
        final int rightPadding = getResources().getDimensionPixelSize(R.dimen
                .pwk_keyboard_padding_right);
        final int bottomPadding = getResources().getDimensionPixelSize(R.dimen
                .pwk_keyboard_padding_bottom);
     ...
     */
    public void update(@NonNull final String number, final int showIndex, final NumberType
            numberType) {
...
//                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (heightMode == MeasureSpec.AT_MOST) {
            height = rows * mDefaultKeyHeight + (rows - 1) * mRowSpace + getPaddingTop() +
                    getPaddingBottom();
            ...
            if (rows > 0) {
                int childHeight = (height - getPaddingTop() - getPaddingBottom() - (rows - 1) *
                        mRowSpace) / rows;
                for (int i = 0; i < rows; i++) {
