...
import com.carkeyboard.support.Objects;
...
public class KeyboardInputController {
    ...
    private final Set<OnNumberTypeChangedListener> mOnNumberTypeChangedListeners = new
            LinkedHashSet<>(4);
    ...
    public KeyboardInputController bindLockTypeProxy(final LockNewEnergyProxy proxy) {
        ...
        mKeyboardView.addKeyboardCallback(new com.carkeyboard.view.KeyboardCallback.Simple() {
            @Override
     ...
     * @return KeyboardInputController
     */
    public KeyboardInputController addOnNumberTypeChangedListener(OnNumberTypeChangedListener
                                                                          listener) {
     ...
     * @return KeyboardInputController
     */
    public KeyboardInputController removeOnNumberTypeChangedListener(OnNumberTypeChangedListener
                                                                             listener) {
