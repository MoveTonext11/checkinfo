...
public class EngineRunner {
    ...
    public void start() {
        ...
        mRhino.evaluateString(mEngineScope, "var engine = new KeyboardEngine()", SOURCE_NAME, 1,
                null);
     ...
     * @return 返回更新之后的键盘信息
     */
    public KeyboardEntry update(KeyboardType keyboardType, int showIndex, @NonNull String
            presetNumber, @NonNull NumberType numberType) {
        if (mUpdateFunction == null) {
            Log.e(TAG, "You need to call start() before call update method");
            return null;
        }
        Object[] params = new Object[]{keyboardType.ordinal(), showIndex, presetNumber,
                numberType.ordinal()};
