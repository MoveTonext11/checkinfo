package com.anrongtec.lasa.view;
...
/**
 * @author libo
 * @Description: 银行卡号输入专用键盘
 * @date 2018/5/14
 */

public class CustomKeyBoard extends AppCompatEditText implements
    ...
    private void initKeyboardView(Context context, AttributeSet attrs) {
        ...
        mKeyboardView = (KeyboardView) LayoutInflater.from(context).inflate(R.layout
                .keyboard_view, null);
        //键盘关联keyboard对象
    ...
    private void notSystemSoftInput() {
        if (Build.VERSION.SDK_INT <= 10) {
            ...
            ((Activity) getContext()).getWindow().setSoftInputMode(WindowManager.LayoutParams
                    .SOFT_INPUT_STATE_ALWAYS_HIDDEN);
            try {
                Class<EditText> cls = EditText.class;
                Method setShowSoftInputOnFocus = cls.getMethod("setShowSoftInputOnFocus", boolean
                        .class);
