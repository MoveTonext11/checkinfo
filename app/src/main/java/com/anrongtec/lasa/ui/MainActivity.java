...
import com.anrongtec.lasa.entity.Function;
...
public class MainActivity extends BaseActivity {
    ...
    private void initFunctionData() {
        ...
        functions.add(new Function(1, getString(R.string.main_function_anjian), R.drawable
                .ic_icon_main_anjian));
//        //信息核查
//        functions.add(new Function(2, getString(R.string.main_function_info_check), R.drawable
//                .ic_icon_main_check));
        //布控
        ...
        functions.add(new Function(4, getString(R.string.main_function_count_analyze), R.drawable
                .ic_icon_main_tongji));
//        //人证合一
//        functions.add(new Function(6, getString(R.string.main_function_person_join), R.drawable
//                .ic_icon_main_person_join));
    }
